...
class TranslationService:
    ...
    def translate_to_indonesian(self, text: str):
        ...
        try:
            ...
            if len(translated) < len(text) * 0.3:  # Terlalu singkat
    ...
    def _translate_fallback(self, text: str):
        ...
        # Simple string replacement untuk istilah umum
        replacements = {
            # Header FDA
        ...
        result = text
        # Lakukan replace case insensitive
        for eng, indo in replacements.items():
            if eng:  # Skip empty keys
                # Case insensitive replace dengan regex
