...
class SimpleRAGPharmaAssistant:
    ...
    def _generate_rag_response(self, question, context):
        ...
        if not gemini_available:
            # Fallback: format jawaban dalam Bahasa Indonesia meskipun Gemini tidak tersedia
            return f"Berikut informasi dari FDA yang relevan:\n\n{context}\n\nCatatan: Model AI tidak tersedia saat ini, sehingga jawaban diambil langsung dari konteks FDA di atas."
        
        try:
            model = genai.GenerativeModel('gemini-2.0-flash')
            
            prompt = f"""
            PERAN: Anda adalah Asisten Farmasi Profesional.
            TUGAS: Jawab pertanyaan pengguna tentang obat menggunakan hanya informasi FDA yang disediakan di bawah.
            BAHASA: Jawaban harus ditulis SEPENUHNYA DALAM BAHASA INDONESIA. Jangan gunakan bahasa lain.
            GAYA: Bahasa yang jelas, mudah dimengerti oleh pasien, ringkas namun lengkap.
            ...
            INSTRUKSI PENTING (IKUTI DENGAN KETAT):
            1. Jawab hanya berdasarkan informasi dari bagian 'INFORMASI RESMI DARI FDA' di atas. Jangan menambahkan fakta baru di luar konteks tersebut.
            2. Fokus pada obat yang paling relevan dengan pertanyaan.
            3. Jika informasi tidak lengkap, jelaskan bagian apa yang tersedia dari FDA dan sebutkan keterbatasannya.
            4. Sertakan peringatan penting bila ada.
            5. Gunakan format narasi yang mudah dibaca oleh pasien (paragraf pendek, poin bila perlu).
            6. SELALU TULIS JAWABAN DALAM BAHASA INDONESIA.
            ...
            # Jika terjadi error saat pemanggilan Gemini, fallback ke konteks dalam Bahasa Indonesia
            return f"Berikut informasi dari FDA yang relevan:\n\n{context}\n\nCatatan: Terjadi masalah saat memanggil layanan AI. Mohon coba lagi nanti."
